...
export default {
    ...
    // computed: {
    //     deleteEmployeeUrl() {
    //         return `/employee/${this.employee.id}/destroy`;
    //     }
    // },
    data() {
        return {
            ...
            service_id: this.employee.services[0],
            errors: {},
        };
    },
    methods: {
        ...
        deleteEmployee() {
            ...
            // console.log('Delete employee with ID:', this.employee.id);
            // You can make an API request or perform any other necessary operations
        }
    },
}
</script>
<template>
    <div class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        <form @submit.prevent="form.post(route('employee.update'), { onSuccess: () => form.reset() })">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <div>
                    ...
                    <select id="service" v-model="service_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="mt-6 text-right">
                    <a :href="route('employee.destroy', this.employee.id)">
                        <div class="mt-6 text-right">
